...
All credit for this addon goes to Jasje.

I just stole the addon, and make it part of my package and built it in for ease.
...
if not C["skin"].auctionator == true then return end
