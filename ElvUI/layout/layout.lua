...
infoleft:SetPoint("BOTTOMRIGHT", chatlph, "BOTTOMRIGHT", E.Scale(-17), E.Scale(-3) - E.textbarheight)
	...
	infoleftLbutton:Point("BOTTOMLEFT", chatlph, "BOTTOMLEFT", 0, E.Scale(-3) - E.textbarheight)
	...
	infoleftRbutton:Point("BOTTOMRIGHT", chatlph, "BOTTOMRIGHT", 0, E.Scale(-3) - E.textbarheight)
...
inforight:SetPoint("BOTTOMRIGHT", chatrph, "BOTTOMRIGHT", E.Scale(-17), E.Scale(-3) - E.textbarheight)
	...
	inforightLbutton:Point("BOTTOMLEFT", chatrph, "BOTTOMLEFT", 0, E.Scale(-3) - E.textbarheight)
	...
	inforightRbutton:Point("BOTTOMRIGHT", chatrph, "BOTTOMRIGHT", 0, E.Scale(-3) - E.textbarheight)
