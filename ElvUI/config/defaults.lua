...
DB["unitframes"] = {
	["enable"] = true,
	["fontsize"] = 14,						-- default font size for unitframes
	...
	["targetdebuffs"] = true,				-- target debuffs above target unitframe
	...
	["castfocuswidth"] = 275,				-- width of focus castbar
